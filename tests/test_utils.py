...
class TestSaveLoad(TestCase):
    ...
    def test_with_example_model_pth(self):
        ...
        # test save
        utils.save('test_tmp.pth',model_description)
        # test load
        md = utils.load('test_tmp.pth',torch.device('cpu'))
    ...
    def test_with_example_model_json(self):
        ...
        model_description = shared.get_model_description_1()
        # test save
        utils.save(('test_json.json','test_json.pth'),model_description)
        # test load
        md = utils.load(('test_json.json','test_json.pth'),torch.device('cpu'),True)
